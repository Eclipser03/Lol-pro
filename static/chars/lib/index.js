...
function init() {
    ...
    textureLoader.load('/static/chars/assets/bg.png', function (texture) {
...
function initGUI() {
    ...
    $.getJSON('/static/chars/assets/index2name.json', function (data) {
        // load index2name
        $.each(data, function (key, val) {
            index2name[key] = val;
        });
        // load index2skin
        $.getJSON('/static/chars/assets/index2skin.json', function (data) {
            $.each(data, function (key, val) {
                index2skin[key] = val;
            });
    ...
    $.getJSON('/static/chars/assets/name2index.json', function (data) {
        $.each(data, function (key, val) {
            name2index[key] = val;
        });
    });
