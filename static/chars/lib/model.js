...
$.getJSON('/static/assets/index2name.json', function (data) {
    $.each(data, function (key, val) {
        index2name[key] = val;
    });
    $.getJSON('/static/assets/index2skin.json', function (data) {
        $.each(data, function (key, val) {
            index2skin[key] = val;
        });
...
$.getJSON('/static/assets/name2index.json', function (data) {
    $.each(data, function (key, val) {
        name2index[key] = val;
    });
});
